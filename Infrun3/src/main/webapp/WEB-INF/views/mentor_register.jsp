		...
		<div class=mentor_register_body>
			...
			<div class="mentor_register_title_container">
				<div class="mentor_register_title_wraper">
					<span class=mentor_register_title_title>Be a mentor and upload a lecture</span>
					<span class=mentor_register_title_subtitle>멘토가 되어서 강의를 업로드해보세요!</span>
				</div>
			</div>
			...
			<form:form modelAttribute="Mentor" method="post"
				...
				<div class="mentor_join_main_container">
					<div class="mentor_join_main_wraper">
						...
						<div class="information_box">
							...
							<div class="information_input_box">
								...
								<textarea id="big_box" name="mainintroduce" placeholder="자기소개를 입력하세요."
					...
					<button type="submit" class="mentor_registration_btn">멘토
						등록</button>
				</div>
