...
<body onload="SuccessCode();selectedOptionCheck()">
	...
	<div class="wrapper" style="margin-top: 100px;">
		<div class="navBar">
			...
			<form action="list" modelAttribute="searchVO" method="get"
				class="search_form">
				<select class="search_sel" id="type" name="type">
					<option value="title">제목</option>
					<option value="content">내용</option>
					<option value="writerId">작성자</option>
				</select> <input class="searchTerm" type="text" id="keyword" name="keyword"
	...
	out.print("");
		...
		<div class="write" align="center">
			...
			<button type="button" onclick="moveAction(2)">
			...
			%>
			<button type="button" onclick="moveAction(1)">
